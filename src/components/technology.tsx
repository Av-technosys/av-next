...
export function TechnologiesOffered({ className = "",childclass="", tabclass="" }: any) {
  return (
    <div
      className={cn(
    ...
    >
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-4 px-4 py-12 sm:gap-6 md:py-20">
        <h1 className={cn("py-4 text-3xl font-medium leading-tight tracking-wider text-gray-200 sm:text-4xl md:text-5xl",childclass)}>
