...
const RealEstateHero = () => {
    ...
    >
      ...
      <div className="mx-auto flex h-[500px] max-w-7xl flex-col items-center justify-center gap-1 rounded-none !px-8 text-center text-white">
        ...
        className='text-white border mt-5 border-white rounded-full px-3 py-2 hover:text-black hover:bg-white duration-300 hover:scale-105'>Consults Our Experts</motion.button>
      </div>
    </div>
  );
}
