          ...
          <>
            <div className="mb-14 w-full">
              <div className="h-[350px] max-w-xs md:max-w-sm">
                <div className="w-full rounded-t-md bg-[rgb(202,138,4)] p-1 text-center text-2xl font-bold text-white">
                  Chat With Us
                </div>

                <div className="flex h-full w-full flex-col justify-end rounded-b-md bg-white p-3 shadow-lg">
                  <div className="mb-2 h-full w-full overflow-x-hidden overflow-y-scroll">
                    {userMsg == '' && (
                      <div className="text-center">No Messages Yet..</div>
                    )}
                    <div className="text-md mb-5 w-full break-words pr-2 text-end">
                      {userRole && (
                        <>
                    ...
                    <div className="max-w-none pr-2 text-start text-sm">
                      {role && (
                        <>
                  ...
                  <form onSubmit={generateText} className="flex gap-2">
                    <input
                      type="text"
                      ref={inpref}
                      className="flex-1 rounded-md border border-gray-500 bg-white px-2 outline-none"
                      placeholder="Type your message..."
                    />
                    <button
                      type="submit"
                      className="h-11 w-11 rounded-md bg-[rgb(202,138,4)] text-white"
                    >
                      Send
                    </button>
                  </form>
                    ...
                    <div className="mb-2 h-full w-full overflow-y-scroll">
                      <div className="text-md mb-5 flex w-full flex-col gap-5 break-words text-start">
                        ...
                        <button
                          ...
                          onClick={() => setchangeBot((prev) => !prev)}
                        >
                          Let's chat
                        </button>
                      </div>
