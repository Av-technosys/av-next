...
const herodetails = {
  ...
  description2:
    '',
  image: 'pageMainPhoto.5d8d68d3[1].png',
};
const leadingdata = {
...
const whychooseheading = {
  ...
  description:
    'Enhance Pet Services and Improve Owner Convenience',
  image: 'petpic2.jpg',
};
const whychoosedata = [
  {
...
const servicesheading={
  ...
  description:"The exact cost of developing a pet care app varies based on several factors. Here’s what impacts your budget."
}
const services = [
  {
