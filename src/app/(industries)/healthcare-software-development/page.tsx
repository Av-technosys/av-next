...
const Page = () => {
    return (
        <>
             ...
             <CaseStudy />
             <Fintecheffect boxheadingclass="md:text-3xl" boxButton={"I'M INTERESTED"} textStyle="md:my-8 my-5 md:text-lg" boxSize="h-[500px]" heading={"Healthcare App Developer Services"} boxclass="lg:grid-cols-3" details={fintechEffectData}/>
             <TechnologiesOffered />
...
const servicesheading={
  ...
  description:"Discover who healthcare app developers are and how they create user-friendly apps to improve medical services for patients and healthcare providers."
}
const services = [
  {
  ...
  },
  {
    ...
    image: '/new/healthcaresm6.jpg',
  },
];
const fintechEffectData = [
  {
    bgImage: '/new/healthcareEffect1.jpg',
  ...
  {
    bgImage: '/new/healthcareEffect2.jpg',
  ...
  {
    bgImage: '/new/healthcareEffect3.jpg',
