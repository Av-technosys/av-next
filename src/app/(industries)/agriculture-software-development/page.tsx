...
const Page = () => {
    return (
        <>
         ...
         <ServicesManaged backgroundClass="bg-slate-100" className="lg:grid-cols-4" heading={servicesheading} services={services}/>
