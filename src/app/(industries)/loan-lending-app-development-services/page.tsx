...
import {DWalletFawData, LoanlandingFawData, mobileBankingFawData } from '@/const';
...
const data={
        ...
        description:"AV Technosys builds advanced loan lending apps that make it simple for users to access fast financing solutions and borrow directly from trusted lenders.",
        image:"loanlandingbanner.jpg"
    }

const leadingdata={
        title:"Custom Loan Management Software Development Partner",
        description1:"Loan lending is currently one of the most popular and profitable segments in the financial sector, with many leading apps generating millions in revenue. If you’re aiming to enter this lucrative market and set new revenue benchmarks, you need innovative loan lending app development services.",
...
const servicedataheading={
    ...
    description:"Our loan lending app development process covers planning, design, development, testing, and support to build a successful and secure app."
}
const serviceData = [
      {
      ...
      },
      {
        ...
        description:
          ` Our team creates wireframes and interactive prototypes to visualise app flow and ensure seamless user journeys before development.`
      },
      {
        name: 'UI/UX Design',
        description:
...
const costdata={
      title:"AV Technosys: Your Trusted Partner for High-Performance Loan Lending App Development Services",
      description :"",
...
const whychooseheading={
      ...
      description:"Partner with AV Technosys to build a secure, feature-rich loan lending app that meets regulations and boosts your business growth.",
