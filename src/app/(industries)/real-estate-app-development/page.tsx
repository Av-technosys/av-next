...
const AppcloneHeading={
  ...
  description:' AV Technosys, we specialize in real estate app development and offerpowerful clone solutions of top-performing platforms. Our apps arescalable, secure, and fully for your business objectives.'
}
 const Appclone = [
    {
