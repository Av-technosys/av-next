...
const Page = () => {
  return (
    <>
      ...
      <TechnologiesOffered />
      <Smartsolutionsection backgroundclass="mt-7 md:mt-14" className="bg-orange-100" heading={Servicesheading} details={Servicesdetails}/>
      <Testimonial/>
...
const leadingdata = {
  ...
  image:
    'astrological-forecast-girl-sits-with-laptop-beach-looks-astrological-chart_101969-2804[1].avif',
};
...
const services = [
  {
    ...
    image: '/new/astrologymanaged1.jpg',
  },
  {
    ...
    image: '/new/astrologymanaged2.jpg',
  },
  {
    title: ' Horoscope & Panchang App Development',
    description:
      'Offer users daily, weekly, and monthly horoscopes with accurate astrological algorithms. We also develop Panchang apps with detailed lagna tables, Choghadiya muhurta, Hora, and more.',
    image: '/new/astrologymanaged3.jpg',
  },
  {
    ...
    image: '/new/astrologymanaged4.jpg',
  },
  {
    ...
    image: '/new/astrologymanaged55.jpg',
  },
  {
    ...
    image: '/new/astrologymanaged6.jpg',
  },
  {
    ...
    image: '/new/astrologymanaged7.jpg',
  },
  {
    title: 'Numerology & Astrological Remedies App Development',
    description:
      'Develop apps providing numerology readings and astrological remedies, offering users personalised recommendations and insights through user-friendly and engaging interfaces.',
    image: '/new/astrologymanaged5.jpg',
  },
];

const aiastrologyheading={
    title:"Advanced Astrology Apps Using AI Intelligence",
    description:"Stay ahead with our AI-integrated astrology app development services. Deliver accurate, highly personalized, and captivating astrological experiences to your users through the power of AI.",
...
const ARandVRdetails={
    ...
    description1:"Hire expert astrology app developers from AV Technosys for solutions designed to captivate astrology enthusiasts. Our team combines deep astrological expertise with advanced development practices to create apps that are engaging, user-friendly, and highly personalized.",
...
const Servicesheading={
    ...
    description:"We combine traditional astrology with modern technology to build innovative apps. Whether launching a new app or upgrading an existing one, our team is here to help."
}
