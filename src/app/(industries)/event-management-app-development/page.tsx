...
const servicesheading={
  ...
  description:"Our team uses the latest technologies to build scalable event management apps with seamless user experiences. Invest in a unique app that boosts attendee engagement and streamlines event coordination with our flexible on-demand development services."
}
const services = [
  {
...
const costdata = {
  ...
  description:
    'Our specialists can bring your vision to life!',
