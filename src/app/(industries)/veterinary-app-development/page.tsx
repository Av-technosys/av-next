...
const Page = () => {
    return (
        <>
            ...
            <ConsultingServicesfintechAll hoverclass=" !bg-slate-100 " heading={servicedataheading} details={serviceData}/>
            ...
            <ThreeCardAlternateimagePosition className="pb-8" title="Why Choose AV Technosys for Your On-Demand Vet App?" desc="Get expert development, customised features, and timely delivery to launch a reliable veterinary app that meets your business goals efficiently." mistakes={vaterinaryMistakeCards}/>
            <Testimonial/>
...
const herodetails = {
  ...
  description2:
    '',
  image: 'Vet-Generic-1024x1024[1].webp',
};
const leadingdata = {
  ...
  image:
    'how-to-find-the-best-veterinarian-for-your-pet[2].webp',
};
...
const groomheading={
    ...
    description:"Enhance your pet care business with AV Technosys. Our expert developers build on-demand pet care apps to take your services online efficiently."
}
const groomdata = [
    {
      id: "01",
      title: "App Like PetCo",
      logo: "/new/petco-logo.svg", 
...
const vaterinaryMistakeCards = [
  {
    ...
    img: '/new/original-b88092e7ef0e68c91caa3973581016c3[1].webp',
