...
const servicesheading={
  ...
  description:"Optimize temple operations with our smart management solutions for smooth, efficient, and transparent workflows."
}
const services = [
  {
