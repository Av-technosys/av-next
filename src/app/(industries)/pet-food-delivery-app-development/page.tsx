...
const Page = () => {
    return (
        <>
            ...
            <ThreeCardAlternateimagePosition className="pb-8" title="Best Pet Food Delivery Apps" desc="Get expert development, customised features, and timely delivery to launch a reliable food delivery app that meets your business goals efficiently." mistakes={petfoodMistakeCards}/>
            <Testimonial/>
