...
const data={
        ...
        description:"AV Technosys is a leading insurance app development company that delivers creative and scalable solutions, empowering insurance firms to expand internationally and enhance their digital capabilities.",
        image:"insurancebanner.jpg"
    }

const leadingdata={
        title:"Trusted Insurance App Development Company",
        description1:"AV Technosys delivers innovative insurance app solutions tailored to your business needs. We have successfully developed multiple insurance apps across regions, helping companies enhance their digital offerings.",
...
const servicedataheading={
    ...
    description:"Discover our insurance app development services to create robust, scalable apps that streamline policy management, claims processing, and customer engagement with ease."
}
const serviceData = [
      {
      ...
      },
      {
        ...
        description:
          `AV Technosys builds powerful customer management systems within insurance apps, allowing businesses to streamline client handling, policy management, and service delivery for improved operational efficiency.`
      },
      {
...
const costdata={
      title:"AV Technosys: Your Trusted Partner for High-Performance Insurance App Development",
      description :"",
...
const whychooseheading={
      ...
      description:"Discover what we offer in insurance app development, including custom apps, claims management, secure payment integration, and AI-powered solutions to grow your insurance business.",
