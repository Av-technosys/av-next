...
const Page = () => {
    return (
        <>
            ...
            <LeadingSectionfintechAll imageclass="md:w-[350px] lg:w-[400px] ml-auto animate-float"  className="md:order-2 " details={leadingdata} />
            <AiAstrologySection heading={aiastrologyheading} details={aiastrologydetails}/>
            <ConsultingServicesfintechAll hoverclass="group-hover:bg-[linear-gradient(-45deg,_#ffc796_0%,_#ff6b95_100%)] !bg-slate-100 " heading={servicedataheading} details={serviceData}/>
            <RealEstateAppClone heading={AppcloneHeading} details={Appclone}/>
            <ProjectCost imageclass="top-[18px] lg:right-[30px]" className="lg:max-w-md" details={costdata} />
            <Fintecheffect hoverbgcolor="bg-rose-400" boxheadingclass="md:text-2xl" boxButton={"I'M INTERESTED"} textStyle="my-5" boxSize="h-[400px]" heading={"Dating App Developement Services"}  details={datingEffectData}/>
...
const leadingdata = {
  ...
  image: 'dating-app-development-solution-img[1].png',
};
...
const AppcloneHeading={
  ...
  description:'Launch your dating app quickly with our ready-to-use clone solutions.'
}
 const Appclone = [
    {
...
const datingEffectData = [
  {
    bgImage: '/new/metaverse-dating-app.webp',
  ...
  {
    bgImage: '/new/matchmaking-dating-app.webp',
  ...
  {
    bgImage: '/new/community-dating-app.webp',
  ...
  {
    bgImage: '/new/hookup-dating-app.webp',
...
const costdata = {
  ...
  image: '1_cRrxnKGYKMjVHAXbiiTlEQ[1].png',
  btn: 'Request A Free Demo Call',
};
const ARandVRdetails={
    title:"Hire Skilled Dating App Developers",
    description1:"Want to turn your dating app idea into reality? Our team of expert developers specialises in building engaging, high-performing dating apps customised to your unique vision and business goals. We focus on quality, innovation, and delivering user-centric solutions.",
