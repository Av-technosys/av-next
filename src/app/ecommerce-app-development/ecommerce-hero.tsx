...
const EcommerceHero = () => {
   const [isLeadOpen, setIsLeadOpen] = useState(false);
    return (
        <section style={{ backgroundImage: "url('/new/ecomcoverbanner3.jpg')" , backgroundPosition:"center",backgroundSize:"cover" ,backgroundRepeat:"no-repeat" }}>
      ...
      <div className=" z-10 max-w-4xl flex flex-col items-center mx-auto">
        <h1 className="text-white text-3xl sm:text-3xl md:text-5xl  font-bold !leading-snug mb-6">
          Ecommerce App<br className="hidden sm:block" />
          Development Company
        </h1>
        <p className="text-white text-lg sm:text-xl  font-medium mb-8">
          AV Technosys is a trusted e-commerce development company, delivering customised, high performance e-commerce solutions. Our expertise ensures your business grows rapidly, scales seamlessly, and achieves success faster.
        </p>
        <motion.button 
         whileTap={{ scale: 0.92 }}
