...
export default function EcommerceAppCost() {
  ...
  return (
    <section className="mx-auto max-w-7xl my-6 md:my-12">
      ...
      <div  className="px-4 py-10 md:relative">
        <div style={{backgroundImage:"url('/new/ecomm-dropshopping-cta.webp')"}} className="mx-auto flex max-w-7xl flex-col items-center gap-10 rounded-3xl px-4 py-6 md:flex-row md:p-8 lg:p-16">
          {/* Left Image Section */}
          <div className="md:right-[0px] md:top-5 lg:right-0 lg:top-[-2px] flex w-[250px] justify-center md:absolute md:w-[500px]">
            <Image
              src="/new/ecommerce-costbanner.png"
          ...
          <div className="w-full text-center text-white md:w-1/2 md:text-left">
            ...
            <p className="mb-6 font-medium lg:text-lg">
              Our scalable real estate apps help brokers, agencies, and investors simplify operations and accelerate growth.
            </p>
            <motion.button
              whileTap={{ scale: 0.92 }}
