...
export default function SmartAiSolutions() {
  const aiIndustries = [
    ...
    {
      image: '/new/Healthcare_ai (1).webp',
      alt: 'Healthcare',
      title: 'Healthcare',
      description:
    ...
    {
      image: '/new/manufacturing_ai.webp',
      alt: 'Manufacturing',
      title: 'Manufacturing',
      description:
    ...
    <section className="mx-auto max-w-7xl bg-white px-4 py-2">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {aiIndustries.map((item, index) => (
          ...
          >
            <img src={item.image} alt={item.alt} className="mb-4 h-10 w-10" />
