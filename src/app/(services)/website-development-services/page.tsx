...
const Page = () => {
    return (
        <>
            <HeroSectionfintechAll className="!text-black" details={data} />
            <Ratings className="md:flex" />
            <LeadingSectionfintechAll details={leadingdata} />
            <Smartsolutionsection heading={Servicesheading} details={Servicesdetails}/>
...
const Servicesheading={
    ...
    description:"AV Technosys provides full-scale web development solutions driven by industry expertise, innovation, and a user-centric approach to digital growth."
}
...
const servicesheading={
    ...
    description:"At AV Technosys, we build secure, scalable websites and web apps that strengthen your business and bring your digital vision to life."
}
const services = [
  {
    title: 'Websites',
    ...
    image: '/new/webservicemanage1.jpg',
  },
  {
    title: 'E-commerce',
    description:
    ...
    image: '/new/webservicemanage11.jpg',
  },
  {
    ...
    image: '/new/webservicemanage3.jpg',
  },
  {
    ...
    image: '/new/webservicemanage4.jpg',
  },
  {
    title: 'Web Portals',
    description:
    ...
    image: '/new/webservicemanage5.jpg',
  },
  {
    title: 'ERP Solutions',
    description:
    ...
    image: '/new/webservicemanage6.jpg',
  },
...
const whychooseheading = {
  ...
  image: 'composition-with-html-system-websites_23-2150866289[1].avif',
};
const whychoosedata = [
  {
